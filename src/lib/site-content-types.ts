...
export const DEFAULT_PUBLIC_TEAM: TeamMember[] = [
  ...
  { id: 'e2', name: 'Ethan Hord', title: 'Managing Editor', group: 'editors', sortOrder: 1 },
  ...
  { id: 'e8', name: 'Aubree Hudson', title: 'Assistant Editor, Family', group: 'editors', sortOrder: 7 },
  ...
  { id: 'sw2', name: 'Jackson Gallini', title: '', group: 'staff_writers', sortOrder: 1 },
  ...
  { id: 'em1', name: 'Jacob Christensen', title: 'Board of Directors', group: 'emeritus', sortOrder: 0 },
  { id: 'em2', name: 'Thomas Stevenson', title: 'Board of Directors', group: 'emeritus', sortOrder: 1 },
